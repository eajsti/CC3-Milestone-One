...
class Main {
        ...
        while (true ) {
            ...
            if (choice.equals("1")) {
                ...
                if (role.equalsIgnoreCase("Driver")) {
                    driverMenu(sc, user, vehicle, area, session, ticket, fine, finance);
                } else if (role.equalsIgnoreCase("Officer")) {
                    officerMenu(sc, ticket, fine, area, session);
                } else if (role.equalsIgnoreCase("Admin")) {
                    adminMenu(sc, user, area, session, ticket, fine, finance);
                }
            } else {
    ...
    static void driverMenu(Scanner sc, UserService user, VehicleService vehicle, 
            ...
            TicketService ticket, FineService fine, FinanceService finance) {
        ...
        while (true) {
            ...
            System.out.println("10. View My Payments");
    ...
    static void adminMenu(Scanner sc, UserService user, ParkingAreaService area, 
            ParkingSessionService session, TicketService ticket, FineService fine, FinanceService finance) {
        while (true) {
            System.out.println("\n--- ADMIN MENU ---");
            ...
            System.out.println("14. View Income Statement");
            System.out.println("15. View Payment History");
            System.out.println("16. Logout");
            System.out.print("Choice: ");
            String ch = sc.nextLine();
            ...
            if (ch.equals("1")) {
                ...
                finance.viewIncomeStatement();
            } else if (ch.equals("15")) {
                finance.viewPaymentHistory();
            } else if (ch.equals("16")) {
                break;
            }
        }
